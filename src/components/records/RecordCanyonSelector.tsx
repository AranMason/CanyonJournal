...
import { Box, Button, CircularProgress, List, ListItem, ListItemButton, ListItemText, ListSubheader, Paper, TextField, Typography } from "@mui/material";
...
const RecordCanyonSelector: React.FC<RecordCanyonSelectorProps> = ({ canyons, value, setCanyon, canyonError }) => {
