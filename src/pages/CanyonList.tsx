...
import { Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Link, CircularProgress, Button } from '@mui/material';
...
const CanyonList: React.FC = () => {
  ...
  return (
    <PageTemplate pageTitle="All Canyons">
